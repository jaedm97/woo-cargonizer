...
<div class="woocngr-shipping-return">
    <div class="button woocngr-btn-send"><?php esc_html_e( 'Send', WOOCNGR_TD ) ?></div>
    <div class="button woocngr-btn-shipping"><?php esc_html_e( 'Override Shipping', WOOCNGR_TD ) ?></div>
    <div class="button woocngr-btn-return"><?php esc_html_e( 'Return', WOOCNGR_TD ) ?></div>
</div>


<div class="woocngr-popup-container">
